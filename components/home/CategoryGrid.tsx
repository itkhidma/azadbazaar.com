      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex gap-4 md:gap-6 lg:gap-8 overflow-x-auto scrollbar-hide pb-2">
          ...
          <Link
            ...
            className="group flex flex-col items-center flex-shrink-0"
          >
            <div className="relative w-14 h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 rounded-full overflow-hidden bg-purple-50 shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center">
